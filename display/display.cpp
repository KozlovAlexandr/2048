...
bool TDisplay::TImpl::IsKeyReleased(EKey key) const {
    switch (key) {
        case EKey::KEY_UP:
            return glfwGetKey(Window, GLFW_KEY_W) == GLFW_RELEASE &&
                   glfwGetKey(Window, GLFW_KEY_UP) == GLFW_RELEASE;
        case EKey::KEY_DOWN:
            return glfwGetKey(Window, GLFW_KEY_S) == GLFW_RELEASE &&
                   glfwGetKey(Window, GLFW_KEY_DOWN) == GLFW_RELEASE;
        case EKey::KEY_LEFT:
            return glfwGetKey(Window, GLFW_KEY_A) == GLFW_RELEASE &&
                   glfwGetKey(Window, GLFW_KEY_LEFT) == GLFW_RELEASE;
        case EKey::KEY_RIGHT:
            return glfwGetKey(Window, GLFW_KEY_D) == GLFW_RELEASE &&
...
bool TDisplay::IsKeyReleased(EKey key) const {
